...
class Patient(BaseModel):
    ...
    name:Annotated[str,Field(...,description='Name of the patient',examples=['Abhinav','Aditya'])]
    city:Annotated[str,Field(...,description='City where the patient is living',examples=['Newyork','Las Vegas'])]
